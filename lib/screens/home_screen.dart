...
class _HomeScreenState extends State<HomeScreen> {
      ...
      builder: (_, channelsP, playerP, __) {
        ...
        return CustomScrollView(
          slivers: [
            ...
            if (grouped.isEmpty && !channelsP.isLoading)
              SliverFillRemaining(
                hasScrollBody: false,
  ...
  /// Groups channels by their category, keeping only non-empty groups
  ...
  IconData _categoryIcon(String cat) {
    ...
    if (cat.contains('رياض') || cat.contains('Sport')) {
      return Icons.sports_soccer_rounded;
    }
    if (cat.contains('فلم') || cat.contains('Movie')) {
      return Icons.movie_rounded;
    }
    if (cat.contains('خبر') || cat.contains('News')) {
      return Icons.newspaper_rounded;
    }
    if (cat.contains('موسيق') || cat.contains('Music')) {
